    ...
    return (
        <div className="flex flex-col gap-5 p-5 md:p-10 lg:py-10 lg:p-24">
            ...
            <div className="flex gap-5 text-center text-white text-2xl overflow-x-scroll hide-scroll rounded-lg w-full justify-between">
                <div className="product-container bg-[url('src/assets/images/companythird1.jpeg')] bg-no-repeat h-72 flex flex-col justify-end relative">
                ...
                <div className="product-container bg-[url('src/assets/images/companythird2.jpeg')] bg-no-repeat h-72 flex flex-col justify-end relative">
                    <div className="w-52 h-14 md:w-72 bg-[#AE0908]">
                ...
                <div className="product-container bg-[url('src/assets/images/companythird3.jpeg')] bg-no-repeat h-72 flex flex-col justify-end relative">
                    <div className="w-52 h-14 md:w-72 bg-[#AE0908]">
