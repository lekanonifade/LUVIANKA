...
export default function Recipesfirst() {
    return (
        <div className="bg-[url('../images/recipesfirstbg.svg')] md:bg-[url('../images/recipesfirstbglg.svg')] bg-no-repeat bg-center bg-cover min-h-[75vh] lg:min-h-screen min-w-screen flex flex-col items-left lg:justify-center text-white gap-5">
