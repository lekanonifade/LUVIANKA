...
export default function Productsfirst() {
    return (
        <div className="bg-[url('src/assets/images/productsfirstbg.svg')] md:bg-[url('src/assets/images/productsfirstbglg.svg')] bg-no-repeat bg-center bg-cover min-h-[75vh] lg:min-h-screen min-w-screen flex flex-col items-left lg:justify-center text-white gap-5">
